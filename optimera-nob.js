...
var PartnerSpecificValidator = require('optimera-nob-validator.js');
...
function OptimeraNob(configs) {
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'OptimeraNob', // PartnerName
            namespace: 'OptimeraNob', // Should be same as partnerName
            statsId: 'OPTI', // Three character unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
